                ...
                <div class="col-3">
                  <div class="wrap-img_post">
                    <a href="<?php echo e($alias); ?>">
                      <img class="w-100" src="<?php echo e($image); ?>" alt="<?php echo e(Str::limit($title, 20)); ?>">
                    </a>
                  </div>
                </div>
                <div class="col-9">
                  <div class="entry-title ms-3">
                    ...
                    <p><?php echo Str::limit($brief, 20); ?></p>
                  </div>
                </div>
              </div>
            </div>
...
<?php /**PATH D:\xampp\htdocs\geem\resources\views/frontend/components/sidebar/post.blade.php ENDPATH**/ ?>