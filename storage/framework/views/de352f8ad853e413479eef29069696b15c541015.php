                                                                            ...
                                                                            <div class="form-body">
                                                                                <div class="form-group mb-3">
                                                                                    ...
                                                                                    <input class="form-control"
                                                                                        ...
                                                                                        data-old="Home"
                                                                                        id="menu-node-title-1"
                                                                                        v-pre="" name="json_params[name][en]"
                                                                                        type="text"
                                                                                        value="<?php echo e($item->json_params->name->en ??""); ?>"
                                                                                    >
                                                                                </div>
                                                                                <div class="form-group mb-3">
                                                                                ...
                                                                                <div class="form-group mb-3">
                                                                                    <label for="menu-style"
                                                                                        class="control-label">
                                                                                        <?php echo app('translator')->get('Menu Style'); ?>
                                                                                    </label>
                                                                                    ...
                                                                                    <select name="json_params[style]"
                                                                                        ...
                                                                                        <option value="normal" selected>
                                                                                            <?php echo app('translator')->get('normal'); ?></option>
                                                                                        <option value="mega">
                                                                                            <?php echo app('translator')->get('mega'); ?></option>
                                                                                    </select>
                                                                                                ...
                                                                                                <div class="form-body">
                                                                                                    ...
                                                                                                    <div
                                                                                                        ...
                                                                                                        <input class="form-control"
                                                                                                            ...
                                                                                                            v-pre="" name="json_params[name][en]"
                                                                                                            type="text"
                                                                                                            value="<?php echo e($item_sub_1->json_params->name->en ??""); ?>"
                                                                                                        >
                                                                                                    </div>
                                                                                                    <div
                                                                                                        class="form-group mb-3">
                                                                                                                    ...
                                                                                                                    <div
                                                                                                                        ...
                                                                                                                        <div
                                                                                                                            ...
                                                                                                                            <input class="form-control"
                                                                                                                                ...
                                                                                                                                v-pre="" name="json_params[name][en]"
                                                                                                                                type="text"
                                                                                                                                value="<?php echo e($item_sub_2->json_params->name->en ??""); ?>"
                                                                                                                            >
                                                                                                                        </div>
                                                                                                                        <div
                                                                                                                            class="form-group mb-3">
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\geem\resources\views/admin/pages/menus/edit.blade.php ENDPATH**/ ?>