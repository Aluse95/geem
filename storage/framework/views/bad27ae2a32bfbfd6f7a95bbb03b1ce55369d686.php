                ...
                <div class="row">
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="form-group">
                      ...
                      value="<?php echo e($detail->json_params->title->en ??""); ?>" >
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-group">
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="form-group">
                      <label>English Brief</label>
                      <textarea  placeholder="Lời giới thiệu Tiếng Anh" name="json_params[brief][en]" id="json_params[brief]" class="form-control" rows="5"><?php echo e($detail->json_params->brief->en ?? ""); ?></textarea>
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <textarea placeholder="Nội dung Tiếng Anh" name="json_params[content][en]" id="json_params[content]" class="form-control" rows="5"><?php echo e($detail->json_params->content->en ??""); ?></textarea>
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-group">
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\geem\resources\views/admin/pages/block_contents/create.blade.php ENDPATH**/ ?>