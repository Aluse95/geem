                ...
                <div class="row">
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="form-group">
                      ...
                      <textarea  placeholder="Lời giới thiệu Tiếng Anh" name="json_params[brief][en]" id="json_params[brief]" class="form-control" rows="5">{{ $detail->json_params->brief->en ?? ""}}</textarea>
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <textarea placeholder="Nội dung Tiếng Anh" name="json_params[content][en]" id="json_params[content]" class="form-control" rows="5">{{$detail->json_params->content->en ??"" }}</textarea>
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-group">
