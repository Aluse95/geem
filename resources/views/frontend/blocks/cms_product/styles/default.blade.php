        ...
        <div class="section bg-transparent my-0 pt-0">
          <div class="container">
            <div class="fancy-title title-border title-center mb-4">
              <h2>Các loại <span class="text-lowercase" style="color: #444">{{ $title }}</span></h2>
            </div>
            <div class="{{ $row }}">
                    ...
                    <div class="col-lg-3 col-md-3 col-6 px-2">
                      <div class="product">
                        <div class="product-image">
                          ...
                          >
                            <div class="add-to-cart btn btn-dark me-2" data-id="{{ $id }}"
                        ...
                        <div class="product-desc">
                          <div class="product-title mb-1">
                            <h3><a href="{{ $alias_child }}">{{ $title_child }}</a></h3>
                          </div>
