...
<script src="{{ asset('themes/frontend/geem/js/jquery.js') }}"></script>
<script src="{{ asset('themes/frontend/geem/js/plugins.min.js') }}"></script>
<script src="{{ asset('themes/frontend/geem/js/functions.js') }}"></script>
<script src="{{ asset('themes/frontend/geem/js/lazysizes.min.js') }}"></script>
